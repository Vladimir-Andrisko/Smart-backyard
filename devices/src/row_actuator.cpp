...
int main(int argc, char* argv[]){
    ...
    try{
        if (argc >= 2){
            ...
            cout << "Config file path:  " << "config/actuator/row_actuator/row1_actuator_desc.json" << endl << endl;
            parseDesc(string("config/actuator/row_actuator/row1_actuator_desc.json"));
            ssdp = new SSDPDevice("1", "roof_actuator", "config/actuator/row_actuator/row1_actuator_desc.json", 60, keepAlive);
        }
